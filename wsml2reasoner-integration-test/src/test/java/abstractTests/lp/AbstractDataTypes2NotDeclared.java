...
public abstract class AbstractDataTypes2NotDeclared extends TestCase implements LP {
    ...
    private static final String ONTOLOGY_FILE = "datatypes2_not_declared.wsml";
    ...
    public void testValuesForNotDeclaredAttributes() throws Exception {
    	...
    	// RDF data types
    	r.addBinding( Results.iri( NS + "anInstance" ), Results.iri( NS + "aPlainLiteral" ), Results._text("Family Guy", "en" ) );
    	r.addBinding( Results.iri( NS + "anInstance" ), Results.iri( NS + "a_PlainLiteral" ), Results._text("Padre de Familia", "es") );
