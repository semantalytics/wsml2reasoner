<h1>WSML2Reasoner</h1>
<p>
The WSML2Reasoner framework is a highly modular architecture which combines various validation, normalization, and transformation functionalities essential to the translation of ontology descriptions
in WSML to the appropriate syntax of several underlying reasoning engines.</p>
...
<h2>Reasoners</h2>
<p>
The framework's flexible architecture allows for easy integration of existing external reasoning components. It first maps WSML to either generic Datalog or <a href="http://www.w3.org/2004/OWL/">OWL</a> (Web Ontology Language), and then uses facades that mediate between the generic Datalog representation and the internal representation specific to the single reasoning engines, or between the resulting OWL representation and an OWL reasoning engine (e.g. <a href="http://pellet.owldl.com/">Pellet</a>). In the following sections, we breifly discuss a few of the reasonings engines currently implemented and tested within the WSML2Reasoner framework.
</p>
<h3>IRIS - (WSML-Core, WSML-Flight)</h3>
<p>
<a href="http://iris-reasoner.org/">IRIS</a>, Integrated Rule Inference System, is an extensible reasoning engine for expressive rule-based languages. Currently IRIS supports the following features:
<ul>
	<li>Safe datalog with (locally) stratified 'negation as failure'</li>
	<li>Detection of un-safe rules <a href="http://iris-reasoner.org/saferules">(algorithm description)</a></li>
	<li>Detection of non-stratified programs with negation <a href="http://iris-reasoner.org/stratification">(algorithm descriptions)</a></li>
...
<p><a href="http://pellet.owldl.com/">Pellet</a> is an open source, <a href="http://www.w3.org/TR/owl-guide/">OWL DL</a> reasoner in Java that is developed, and commercially supported, by <a href="http://clarkparsia.com/">Clark &amp; Parsia LLC</a>. Pellet is based on the tableaux algorithms for expressive Description Logics (DL) and supports the full expressivity of OWL DL, including reasoning about nominals (enumerated classes).</p>
