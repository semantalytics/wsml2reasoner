...
public class WSML2OWLTest extends BaseDLReasonerTest {
    ...
    // LogicalExpression le = (LogicalExpression)
    ...
    /**
     * This test checks for transformation of wsml AttributeConstraintMolecule
     * to owl datatype property.
     */
    ...
    /**
     * This test checks for transformation of wsml transitive axiom to owl
    ...
    /**
     * This test checks for transformation of wsml symmetric axiom to owl
    ...
    // /**
    // * This test checks for transformation of wsml logical expression to owl
    // object
    ...
    /**
     * This test checks for transformation of wsml logical expression to owl
     * object property domain and owl subClass definition.
     */
    ...
    /**
     * This test checks for transformation of wsml equivalence logical
     * expression with conjunction to two owl subClass definitions with
     * intersectionOf.
     */
    ...
    /**
     * This test checks for transformation of wsml equivalence logical
     * expression with conjunction to owl subClasses.
     */
    ...
    /**
     * This test checks for transformation of wsml equivalence logical
     * expression with conjunction to owl subClass with intersectionOf.
     */
    ...
    /**
     * This test checks for transformation of wsml logical expression with
     * disjunction to owl subClass definitions with intersectionOf.
     */
    ...
    /**
     * This test checks for transformation of wsml logical expression with
     * negation to owl subClass definitions with intersectionOf.
     */
    ...
    /**
     * This test checks for transformation of wsml logical expression with
     * forall to owl definitions with allValuesFrom.
     */
    ...
    /**
     * This test checks for transformation of wsml logical expression with
     * forall and exists to owl definitions with someValuesFrom.
     */
    ...
    /**
     * This test checks for transformation of wsml logical expression with
     * exists to owl definitions with someValuesFrom.
     */
...
/*
 * $Log: not supported by cvs2svn $ Revision 1.2 2007-08-14 16:53:35 graham
 * Refactored to allow packaged/bundled unit tests (resets
 * BaseReasonerTest.reasoner in tearDown method)
 * 
 * Revision 1.1 2007-08-10 17:20:18 graham Bundled and refactored variant
 * specific tests
 * 
 * Revision 1.1 2007-08-08 10:58:02 graham Second stage of refactoring unit
 * tests
 * 
 * Revision 1.10 2007-04-26 17:39:14 graham Fixed switch to new wsmo4j jars,
 * switched to new IRIS (20070426) and jgrapht (v0.7.1) jars, and removed
 * warning suppressions
 * 
 * Revision 1.9 2007/01/10 14:17:58 nathalie *** empty log message ***
 * 
 * Revision 1.8 2006/08/31 12:33:09 nathalie removed serializing methods from dl
 * reasoner interface and implementation and put them into specific serializer
 * interfaces and classes
 * 
 * Revision 1.7 2006/08/10 08:26:48 nathalie renamed test files
 * 
 * Revision 1.6 2006/07/25 13:23:15 nathalie fixed examples
 * 
 * Revision 1.5 2006/07/23 15:20:23 nathalie updated tests and testfiles
 * 
