...
public class DataValuesTest extends BaseNormalizationTest {
    ...
    protected void setUp() throws Exception {
        ...
        dlReasoner = new DLBasedWSMLReasoner(WSMLReasonerFactory.BuiltInReasoner.PELLET, new WsmlFactoryContainer());
    ...
    public void testString() throws Exception {
        ...
        assertTrue(writer.toString().contains("value(a:hasName \"Mary Jones\"^^<http://www.w3.org/2001/XMLSchema#string>))"));
    ...
    public void testDecimal() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasDecimal \"-1.5\"^^<http://www.w3.org/2001/XMLSchema#decimal>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testInteger() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasAge \"31\"^^<http://www.w3.org/2001/XMLSchema#integer>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testFloat() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasFloat \"-0.0605\"^^<http://www.w3.org/2001/XMLSchema#float>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testDouble() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasDouble \"5.85E-4\"^^<http://www.w3.org/2001/XMLSchema#double>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testSqname() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasSQName b:testOntology))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testBoolean() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:isWoman \"true\"^^<http://www.w3.org/2001/XMLSchema#boolean>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testDuration() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasDuration \"P66Y2M3DT10H20M10S\"^^<http://www.w3.org/2001/XMLSchema#duration>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testDateTime() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasBirthday \"1977-02-07T10:20:10GMT+00:12\"^^<http://www.w3.org/2001/XMLSchema#dateTime>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testDateTimeShort() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasBirthday \"1977-02-07T10:20:10\"^^<http://www.w3.org/2001/XMLSchema#dateTime>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testTime() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasName \"10:20:10GMT+00:12\"^^<http://www.w3.org/2001/XMLSchema#time>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testTimeShort() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasName \"10:20:10\"^^<http://www.w3.org/2001/XMLSchema#time>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testDate() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasBirthday \"1967-08-16GMT+00:12\"^^<http://www.w3.org/2001/XMLSchema#date>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testDateShort() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasBirthday \"1967-08-16\"^^<http://www.w3.org/2001/XMLSchema#date>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testGyearmonth() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasName \"1977-02\"^^<http://www.w3.org/2001/XMLSchema#gYearMonth>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testGyear() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasName \"1977\"^^<http://www.w3.org/2001/XMLSchema#gYear>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testGmonthday() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasName \"02-07\"^^<http://www.w3.org/2001/XMLSchema#gMonthDay>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testGday() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasName \"7\"^^<http://www.w3.org/2001/XMLSchema#gDay>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testGmonth() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasName \"2\"^^<http://www.w3.org/2001/XMLSchema#gMonth>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testHexbinary() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasName \"0FB7\"^^<http://www.w3.org/2001/XMLSchema#hexBinary>))"));
        axiom.removeDefinition(le);
    }
    ...
    public void testBase64binary() throws Exception {
        ...
        serializer.serialize(owlOntology, writer, prefs);
        // System.out.println(writer.toString());
        assertTrue(writer.toString().contains("value(a:hasName \"R01G0DdhNgAPAPAAAAACTYyPq\"^^<http://www.w3.org/2001/XMLSchema#base64Binary>))"));
        axiom.removeDefinition(le);
    }
