...
public abstract class AbstractRuleHead1EqualityTest extends TestCase implements
	...
	public void testExample01() throws Exception {
		...
		r.addBinding( Results.iri("http://simple#x1"), Results.iri("http://simple#x1") );
		r.addBinding( Results.iri("http://simple#x1"), Results.iri("http://simple#x2") );
		r.addBinding( Results.iri("http://simple#x2"), Results.iri("http://simple#x1") );
		r.addBinding( Results.iri("http://simple#x2"), Results.iri("http://simple#x2") );
