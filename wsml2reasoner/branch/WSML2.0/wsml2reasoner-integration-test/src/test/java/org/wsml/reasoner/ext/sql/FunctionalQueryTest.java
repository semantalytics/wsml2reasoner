...
public class FunctionalQueryTest extends TestCase
{
	...
	private final String lotrOntology = "lordOfTheRings.wsml";
	private final String simpsonsOntology = "simpsons.wsml";
...
//		WsmoFactory wsmoFactory = new WsmlFactoryContainer().getWsmoFactory();
		...
		ontologyIRI1 = loader.getResource(lotrOntology);
		ontologyIRI2 = loader.getResource(simpsonsOntology);
