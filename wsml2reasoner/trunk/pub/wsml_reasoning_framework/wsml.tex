...
Modeling Ontology (WSMO)~\cite{roman05:_web_servic_model_ontol} and is based on well-known logic-based
...
play a central role
in WSML as (global) identifiers. The concept of namespaces is used for
