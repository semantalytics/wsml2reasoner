...
considering the instance \syn{MSNDialup} from the WSML ontology in
Section~\ref{sec:wsml}, there is no fact
$\pmo(10,\syn{\_integer})$ for the value of the
\syn{providesBandwidth} attribute. Any time a value is defined for
an attribute constrained by \synkw{ofType}, Axiom (4) would cause
