...
public class WsmlOwlSerializer implements Serializer {
	 ...
	 * 
	 * @param arg0 TopEntity array containing a WSML DL ontology to be transformed to owl
	...
	/**
	 * This method allows to serialize a WSML-DL ontology to either OWL-RDF syntax 
	 * or OWL abstract syntax. The resulting OWL ontology must not necessarily be 
	 * valid OWL DL. The serialized ontology could be validated at an online validator 
	 * as e.g. "http://phoebus.cs.man.ac.uk:9999/OWL/Validator".
	 * 
	 * @param arg0 TopEntity array containing a WSML DL ontology to be transformed to owl
	 * @param arg1 Writer to be written to
	...
	private OWLOntology transformOntology(TopEntity[] te) {
		...
		DLBasedWSMLReasoner reasoner = new DLBasedWSMLReasoner(
				BuiltInReasoner.PELLET, new WSMO4JManager());   
