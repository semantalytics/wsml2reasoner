...
package org.deri.wsml.reasoner.wsmlcore.wrapper.kaon2;
...
public class Kaon2Facade implements DatalogReasonerFacade {
    ...
    private Set<Rule> translateKnowledgebase(
            org.deri.wsml.reasoner.wsmlcore.datalog.Program p)
            throws ExternalToolException {
     ...
     */
    private Rule translateRule(org.deri.wsml.reasoner.wsmlcore.datalog.Rule r)
            throws ExternalToolException {
        ...
        // Care about body
        for (org.deri.wsml.reasoner.wsmlcore.datalog.Literal bl : r.getBody()) {
        ...
        try {
            ...
            for (org.deri.wsml.reasoner.wsmlcore.datalog.Term arg : args) {
                if (arg.getClass().equals(
                        org.deri.wsml.reasoner.wsmlcore.datalog.Variable.class)) {
                    terms
                            .add(f
                                    .variable(((org.deri.wsml.reasoner.wsmlcore.datalog.Variable) arg)
                                            .getSymbol()));
                }
                if (arg.getClass().equals(
                ...
                if (arg
                        .getClass()
                        .equals(
                                org.deri.wsml.reasoner.wsmlcore.datalog.DataTypeValue.class)) {
