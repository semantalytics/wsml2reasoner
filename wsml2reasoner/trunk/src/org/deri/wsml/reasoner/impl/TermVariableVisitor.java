...
import org.deri.wsml.reasoner.normalization.*;
 ...
 */
public class TermVariableVisitor extends PostfixOrderTermVisitor {
    ...
    /* (non-Javadoc)
     * @see org.deri.wsml.reasoner.normalization.PostfixOrderTermVisitor#handleVariable(org.omwg.logexpression.terms.Variable)
     */
    @Override
