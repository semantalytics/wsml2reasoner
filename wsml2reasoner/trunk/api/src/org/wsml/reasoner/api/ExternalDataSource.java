...
public interface ExternalDataSource {
	 ...
	 * @param id the id you want the entries to restrict to 
	 * (use <code>null</code> if you don't want to restrict on the id)
	 * @param name the name you want the entries to restrict to 
	 * (use <code>null</code> if you don't want to restrict on the name)
	 * @param value the value you want the entries to restrict to 
	 * (use <code>null</code> if you don't want to restrict on the value)
	 ...
	 * @param id the id you want the entries to restrict to 
	 * (use <code>null</code> if you don't want to restrict on the id)
	 * @param concept the concept you want the entries to restrict to 
	 * (use <code>null</code> if you don't want to restrict on the concept)
	...
	public static final class HasValue {
		...
		public boolean equals(final Object o) {
			...
			return id.equals(hv.id) 
					&& name.equals(hv.name) 
					&& value.equals(hv.name);
		}
	...
	public static final class MemberOf {
		 ...
		 * @param concept the concept of the member
		 * @throws IllegalArgumentException if the id is <code>null</code>
		 * @throws IllegalArgumentException if the concept is <code>null</code>
		 */
