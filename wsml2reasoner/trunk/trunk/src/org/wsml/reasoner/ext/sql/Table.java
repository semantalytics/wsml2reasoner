...
/**
 * This class is involved in several intermediate processing steps and serves as an encapsulation
 * of the reasoner result in a format that allows db style operations.
 * 
...
public class Table 
{
	...
	/**
	 * Each column is named. This method returns the name corresponding to a certain index.
	 * 
	...
	/**
	 * Each column shares a common type for all entries. This is a requirement to 
	 * store it in an SQL database. This method returns the type for a column index.
	 * 
	 * @param column The column index, starting at 0.
	 ...
	 * 
	 * @param i The position at which to insert the row.
	 ...
	 * means that for all the entries in a column it derives the most general possible
	 * data-type and converts all the entries to this representation.
	 */
	public void promoteDataTypes()
	{
		...
		for (int j = 0; j < columnCount; j++)
		{
			for (int i = 0; i < table.size(); i++)
			{
				...
				else //for every further row we need to determine the biggest type
				{
	...
	{		
		...
		{
			throw new UnsupportedOperationException("Determining column names " +
					"for an empty table is not possible.");
		}
	}
