...
public class InverseImplicationReductionRules extends FixedModificationRules {
    ...
    protected class InvImplLeftConjunctionReplacementRule implements NormalizationRule {
        public LogicalExpression apply(LogicalExpression expression) {
            ...
            LogicalExpression impliedBy1 = leFactory.createInverseImplication(((Conjunction) leftArg).getLeftOperand(), rightArg);
            LogicalExpression impliedBy2 = leFactory.createInverseImplication(((Conjunction) leftArg).getRightOperand(), rightArg);
    ...
    protected class InvImplRightDisjunctionReplacementRule implements NormalizationRule {
        public LogicalExpression apply(LogicalExpression expression) {
            ...
            LogicalExpression leftArg = invImpl.getLeftOperand();
            LogicalExpression rightArg = invImpl.getRightOperand();
            LogicalExpression impliedBy1 = leFactory.createInverseImplication(leftArg, ((Disjunction) rightArg).getLeftOperand());
            LogicalExpression impliedBy2 = leFactory.createInverseImplication(leftArg, ((Disjunction) rightArg).getRightOperand());
            LogicalExpression and = leFactory.createConjunction(impliedBy1, impliedBy2);
            return and;
        }
