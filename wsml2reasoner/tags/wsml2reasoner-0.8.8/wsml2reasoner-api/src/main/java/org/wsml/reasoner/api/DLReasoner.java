...
public interface DLReasoner extends WSMLReasoner {
	 ...
	 * that must identify a (possible) set of instances. The Logical Expression
	 * must not be a rule or contain implications.
	 * 
	...
	/**
	 * This method does a "CONCEPT SATIFIABLITY TEST" on the given logical
	 * expression that must identify a (possible) set of instances. It must be
	 * created using the following language elements: <br />
	 * - Atom<br />
	 ...
	 *             if a logical expression different than the ones mentioned
	 *             above are given as input
	 * @param expression
	 * @return true if the given expression is consistent, false otherwise
	 */
	 ...
	 * Datalog or a DL reasoner is used: - Datalog: the method returns all sub
	 * concepts, including equivalent concepts! - DL: the method returns all sub
	 * concepts, except the equivalent concepts!
	 * 
	 * @param concept
	 ...
	 * method returns all direct sub concepts, except the equivalent concepts!
	 * 
	 * @param concept
	 ...
	 * there is a cycle like e.g. the following: - school subConceptOf place -
	 * university subConceptOf school - place subConceptOf university - DL: the
	 * method returns all direct super concepts, except the equivalent concepts!
	 * 
	 * @param concept
	...
	/**
	 * Get all concepts equivalent to the given concept. This method is not
	 * supported from the Datalog Reasoners!
	 * 
	 * @param concept
	...
	/**
	 * Check if two given concepts are equivalent. This method is not supported
	 * from the Datalog Reasoners!
	 * 
	...
	/**
	 * Get identifiers of sub relations of a given relation. This method is not
	 * supported from the Datalog Reasoners!
	 * 
	 * @param attributeId
	...
	/**
	 * Get all identifiers of direct subrelations of a given relation. This
	 * method is not supported from the Datalog Reasoners!
	 * 
	 * @param attributeId
	...
	/**
	 * Get all identifiers of super relations of a given relation. This method
	 * is not supported from the Datalog Reasoners!
	 * 
	 * @param attributeId
	...
	/**
	 * Get all identifiers of direct super relations of a given relation. This
	 * method is not supported from the Datalog Reasoners!
	 * 
	 * @param attributeId
	...
	/**
	 * Get the identifiers of all relations/attributes equivalent to the given
	 * relation/attribute. This method is not supported from the Datalog
	 * Reasoners!
	 * 
	 * @param attributeId
	...
	/**
	 * Get the identifiers of all relations/attributes inverse to the given
	 * relation/attribute. This method is not supported from the Datalog
	 * Reasoners!
	 * 
	 * @param attributeId
	...
	/**
	 * Get all inferring attributes of a specified instance and for each a set
	...
	/**
	 * Get all constraint attributes of a specified instance and for each a set
	 * containing all its values.
	 * 
	 * @param instance
	 ...
	 */
	public Map<IRI, Set<DataValue>> getConstraintAttributeValues(
			Instance instance);

	/**
	 * Get all instances who have values for a specified inferring attribute and
	 * for each a set containing all its values.
	 * 
	 * @param attributeId
	...
	/**
	 * Get all instances who have values for a specified constraint attribute
	 * and for each a set containing all its values.
	 * 
	 * @param attributeId
	 * @return a map containing all instances who have values for a specified
	 ...
	 */
	public Map<Instance, Set<DataValue>> getConstraintAttributeInstances(
			Identifier attributeId);
	 ...
	 *         inferring attribute
	 */
	public Set<Term> getInferingAttributeValues(Instance subject,
			Identifier attributeId);
	 ...
	 *         attribute
	 */
	public Set<DataValue> getConstraintAttributeValues(Instance subject,
			Identifier attributeId);
}