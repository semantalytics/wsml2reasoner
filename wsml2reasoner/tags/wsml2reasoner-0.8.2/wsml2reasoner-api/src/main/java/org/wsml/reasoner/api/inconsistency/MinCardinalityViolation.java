...
public class MinCardinalityViolation extends CardinalityViolation {
    ...
    public String toString() {
        return "Minimum cardinality violation on instance: " + toString(getTerm(), te) + " attribute " + toString(getAttribute().getIdentifier(), te) + " should have " + getAttribute().getMinCardinality() + " value(s) ";
    }
