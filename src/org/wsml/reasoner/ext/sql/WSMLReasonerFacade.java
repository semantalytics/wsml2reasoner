...
public class WSMLReasonerFacade
{
	 ...
	 * @throws IOException
	 */
	public ReasonerResult executeWsmlQuery(String query, String ontologyIRI)
			throws ParserException, InconsistencyException, IOException,
			InvalidModelException
	{
		...
		LogicalExpressionFactory leFactory = manager
	 ...
	 * @throws IOException
	 */
	protected Ontology loadOntology(String ontologyIri) throws IOException,
