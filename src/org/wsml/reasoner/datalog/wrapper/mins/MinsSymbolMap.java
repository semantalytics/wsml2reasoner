...
public class MinsSymbolMap {
    ...
    public String convertToWSML(int variableNo, ConjunctiveQuery query){
        return convertToWSMLHelper(variableNo,query);
    }
    
    public String convertToWSML(int variableNo, Rule rule){
        return convertToWSMLHelper(variableNo,rule);
    }

    private String convertToWSMLHelper(int variableNo, Object datalogRuleOrQuery){
        List<String> mins2wsml = mins2wsmlVariablesPerRule.get(datalogRuleOrQuery);
