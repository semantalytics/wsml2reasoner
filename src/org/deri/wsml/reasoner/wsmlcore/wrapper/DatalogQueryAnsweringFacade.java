 ...
 */
public interface DatalogQueryAnsweringFacade {
    
       /**
        * Evaluates a given query on a particular external tool.
        * 
        * @param q the query to be evaluated. The query contains a reference to the
        *        knowledgebase against which the query is posed.
        * @return an object that represents the query result, 
        *         i.e. a list of variable bindings for the query.
        * @throws ExternalToolException in case that some error occurs during the execution
        *         of the query 
        */
        ...
        * between datalog representation and the syntax that is allowed by the particular
        * external tool.
        * 
        * @param sf - the symbol factory to be used which delivers valid symbols for the tool.
        */
